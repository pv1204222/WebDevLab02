...
def links_section():
    ...
    emai_html = f'<a href = "mailinfo:{info.my_email_address}"><img src = "{info.email_image_url}" alt = "Email" width = "75" height = "75"></a>'
    st.sidebar.markdown(emai_html,unsafe_allow_html=True)
links_section() 
